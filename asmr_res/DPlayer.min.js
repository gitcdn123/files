!function (e, t) {
    ...
    return function (e) {
        ...
        var o = a(6), r = Object.prototype.toString;
        ...
        function p(e, t) {
            if (null != e) if ("object" !== n(e) && (e = [e]), i(e)) for (var a = 0, o = e.length; a < o; a++) t.call(null, e[a], a, e); else for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && t.call(null, e[r], r, e)
        }
        ...
        e.exports = function (e) {
            "use strict";
            var t = "", a = (e = e || {}).enableSubtitle, o = e.subtitle, r = e.current, i = e.airplay, l = e.pic,
                s = n.$escape, d = e.screenshot, p = e.preload, c = e.url;
            a = o && "webvtt" === o.type;
        ...
        e.exports = function (e, t, a) {
            if (!t) return e;
            var r;
            if (a) r = a(t); else if (n.isURLSearchParams(t)) r = t.toString(); else {
                var i = [];
        ...
        "use strict";
        (function (t) {
            var n = a(0), o = a(46), r = {"Content-Type": "application/x-www-form-urlencoded"};
        ...
        "use strict";
        var n = a(0), o = a(47), r = a(7), i = a(49), l = a(52), s = a(53), d = a(11);
        e.exports = function (e) {
        ...
        e.exports = function (e, t) {
            t = t || {};
            var a = {}, o = ["url", "method", "params", "data"], r = ["headers", "auth", "proxy"],
            ...
            var l = o.concat(r).concat(i), s = Object.keys(t).filter((function (e) {
        ...
        e.exports = function (e) {
            "use strict";
            e = e || {};
            var t = "", o = (arguments[1], function (e) {
                return t += e
            }), r = e.video, i = e.options, l = n.$escape, s = e.tran, d = e.icons, p = e.index, c = n.$each;
            e.$value, e.$index;
        ...
        function s(e, t) {
            for (var a = {}, n = [], o = 0; o < e.length; o++) {
                var r = e[o], s = t.base ? r[0] + t.base : r[0], d = a[s] || 0, p = "".concat(s, " ").concat(d);
                a[s] = d + 1;
                var c = l(p), u = {css: r[1], media: r[2], sourceMap: r[3]};
        ...
        function y(e, t, a) {
            var n = a.css, o = a.media, r = a.sourceMap;
        ...
        (function (e, t) {
            !function (e, a) {
                "use strict";
                if (!e.setImmediate) {
                    var n, o, r, i, l, s = 1, d = {}, p = !1, c = e.document,
        ...
        "use strict";
        var n = a(0), o = a(6), r = a(42), i = a(12);

        function l(e) {
            var t = new r(e), a = o(r.prototype.request, t);
        ...
        "use strict";
        var n = a(0), o = a(7), r = a(43), i = a(44), l = a(12);
        ...
        (function (t) {
            ...
            n.$escape = function (e) {
                return function (e) {
                    var t = "" + e, a = o.exec(t);
                    if (!a) return e;
                    var n = "", r = void 0, i = void 0, l = void 0;
                ...
                if (Array.isArray(e)) for (var a = 0, n = e.length; a < n; a++) t(e[a], a); else for (var o in e) t(e[o], o)
            }, e.exports = n
        }).call(this, a(4))
    }, function (e, t, a) {
        "use strict";
        a.r(t);
        a(35);
        var n = a(15), o = /mobile/i.test(window.navigator.userAgent), r = {
            ...
            getBoundingClientRectViewLeft: function (e) {
                ...
                if (e.getBoundingClientRect) {
                    ...
                    var n = e.getBoundingClientRect(), o = this.getBoundingClientRectViewLeft.offset;
                    return n.left + o
                }
            ...
            setScrollPosition: function (e) {
                var t = e.left, a = void 0 === t ? 0 : t, n = e.top, o = void 0 === n ? 0 : n;
        ...
        var c = {
            ...
            }, y = a(17), h = a.n(y), m = a(18), f = a.n(m), v = a(19), b = a.n(v), g = a(20), w = a.n(g), x = a(21),
            k = a.n(x), S = a(22), T = a.n(S), L = a(23), E = a.n(L), q = a(24), B = a.n(q), M = a(25), z = a.n(M),
            C = a(26), A = a.n(C), O = a(27), P = a.n(O), j = a(28), F = a.n(j), _ = a(29), Y = a.n(_), D = a(30),
            R = a.n(D), I = a(31), H = a.n(I), W = a(32), N = a.n(W), U = a(33), V = a.n(U), X = {
                play: h.a,
                pause: f.a,
                volumeUp: b.a,
                volumeDown: w.a,
        ...
        var ee = function () {
            ...
            return t = e, (a = [{
                ...
                key: "draw", value: function (e) {
                    var t = this;
                    if (this.showing) {
                        var a = this.options.height, n = this.container.offsetWidth, o = this.container.offsetHeight,
                            i = parseInt(o / a), l = function (e) {
                        ...
                        for (var p = document.createDocumentFragment(), c = function (o) {
                            ...
                            var l = t._measure(e[o].text), s = void 0;
                            switch (e[o].type) {
                                case"right":
        ...
        var Oe = 0, Pe = [], je = function () {
            ...
            return t = e, o = [{
                ...
                key: "play", value: function (e) {
                    ...
                    })), this.timer.enable("loading"), this.container.classList.remove("dplayer-paused"), this.container.classList.add("dplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex) for (var a = 0; a < Pe.length; a++) this !== Pe[a] && Pe[a].pause()
                }
            }, {
                    ...
                    if (this.type = t, this.options.video.customType && this.options.video.customType[t]) "[object Function]" === Object.prototype.toString.call(this.options.video.customType[t]) ? this.options.video.customType[t](this.video, this) : console.error("Illegal customType: ".concat(t)); else switch ("auto" === this.type && (/m3u8(#|\?|$)/i.exec(e.src) ? this.type = "hls" : /.flv(#|\?|$)/i.exec(e.src) ? this.type = "flv" : /.mpd(#|\?|$)/i.exec(e.src) ? this.type = "dash" : this.type = "normal"), "hls" === this.type && (e.canPlayType("application/x-mpegURL") || e.canPlayType("application/vnd.apple.mpegURL")) && (this.type = "normal"), this.type) {
                        case"hls":
                            if (window.Hls) if (window.Hls.isSupported()) {
                                var n = this.options.pluginOptions.hls, o = new window.Hls(n);
                        ...
                        case"webtorrent":
                            if (window.WebTorrent) if (window.WebTorrent.WEBRTC_SUPPORT) {
                                ...
                                var s = this.options.pluginOptions.webtorrent, d = new window.WebTorrent(s);
